...
import com.daoshengwanwu.android.tourassistant.item.track.item0Holder;
import com.daoshengwanwu.android.tourassistant.item.track.item1;
import com.daoshengwanwu.android.tourassistant.item.track.item1Holder;
...
public class TrackAdapter extends BaseAdapter{
    ...
    public TrackAdapter(Context mContext, List<BaseItem> dataList) {
        super();
